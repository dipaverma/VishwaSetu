!(function (t, e) {
    ...
    return (function (t) {
      ...
      function (t, e, n) {
        ...
        var i = (function () {
          function t(t) {
            (this.transliterationProvider = t), this.registerListeners();
          }
          return (
      ...
      function (t, e, n) {
        ...
        var o = n(4),
          s = (function () {
            function t(t) {
              (this.transliterationProvider = t), this.renderInitial();
            }
            return (
              (t.prototype.renderInitial = function () {
                ...
                t.classList.add("lds-ellipsis");
                for (var e = 0; e <= 3; e++) {
                  var n = document.createElement("div");
                  t.appendChild(n);
                }
                this.loadingBox.appendChild(t),
                  ...
                  return i(this, void 0, void 0, function () {
                    ...
                    return r(this, function (n) {
                      switch (n.label) {
                        ...
                        case 1:
                        case 2:
                          return this.endSuggestions(), [3, 7];
                        case 3:
                          return (
                        ...
                        case 6:
                          return (
                            (e = n.sent()) &&
                              ...
                              (this.updateSuggestions(e.values),
                              this.loadingBox.classList.add("hidden")),
                            [3, 7]
                          );
                        case 7:
              ...
              (t.prototype.endSuggestions = function () {
                if (this.suggestions && this.suggestions.length > 0) {
                  var t = this.suggestions[this.selectedSuggestion].trim();
                  (this.suggestionInputBox.value = ""),
                    (this.suggestions = []),
                    (this.suggestionsList.innerHTML = ""),
                    this.updateDisplayState();
                  var e = this.transliterationProvider.inputArea.value,
                    n = e.substring(0, this.initialSelectionStart),
                  ...
                  (i = i.trim()),
                    ...
                    (this.transliterationProvider.inputArea.selectionEnd =
                      this.initialSelectionStart + t.length + 1);
                }
              }),
                  ...
                  this.suggestions &&
                    this.suggestions.forEach(function (e, n) {
                      ...
                      (i.innerHTML = e),
                        ...
                        n === t.selectedSuggestion && i.classList.add("active"),
              ...
              (t.prototype.selectSuggestion = function (t) {
                t >= 0 &&
                  t <= 5 &&
                  ((this.selectedSuggestion = t), this.endSuggestions());
              }),
              (t.prototype.startSuggestions = function (t) {
                ...
                var e = this.transliterationProvider.inputArea,
                  ...
                  i = this.transliterationProvider.inputArea.getBoundingClientRect();
                ...
                var r = n.top + 10 + i.top,
                  s = n.left + 10 + i.left;
                r > window.innerHeight - 250 && (r = window.innerHeight - 250),
                  s > window.innerWidth - 150 && (s = window.innerWidth - 150),
              ...
              e.forEach(function (t) {
                if (c && "lineHeight" === t)
                  if ("border-box" === d.boxSizing) {
                    ...
                    l.lineHeight =
                      e > i ? e - n + "px" : e === i ? d.lineHeight : 0;
                  } else l.lineHeight = d.height;
                else l[t] = d[t];
              }),
              i
                ? t.scrollHeight > parseInt(d.height) && (l.overflowY = "scroll")
                : (l.overflow = "hidden"),
              (u.textContent = t.value.substring(0, r)),
              c && (u.textContent = u.textContent.replace(/\s/g, " "));
            var p = document.createElement("span");
            (p.textContent = t.value.substring(r) || "."), u.appendChild(p);
            var f = {
      ...
      function (t, e, n) {
        ...
        var o = (function () {
          function t(t, e) {
            (this.apiUrl = "https://inputtools.google.com/request?text="),
              (this.language = "ne"),
                    ...
                    case 0:
                      return (
                        ...
                        this.transliterationProvider &&
                          (this.transliterationProvider.lastApiUpdate = e),
                        "" === t
                          ? [3, 3]
                          : ((n =
                              this.apiUrl +
        ...
        function p(t, e) {
          for (var n = 0; n < t.length; n++) {
            ...
            if (r) {
              ...
              for (; s < i.parts.length; s++) r.parts.push(y(i.parts[s], e));
            } else {
              var a = [];
